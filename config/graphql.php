    ...
    'schemas' => [
        'default' => [
            'query' => [
                ...
                'allComments'=>\App\GraphQL\Queries\allComments::class,
                'comment'=>\App\GraphQL\Queries\Comment::class,
                'article'=>\App\GraphQL\Queries\Article::class,
            ],
            'mutation' => [
                "register"=>\App\GraphQL\Mutations\Auth\RegisterUser::class,
                "login"=>\App\GraphQL\Mutations\Auth\LoginUser::class
            ],
            'middleware' => [],
            'method'     => ['get', 'post'],
        ],
        'user'=>[
            ...
            'mutation'=>[
                'createArticle'=>\App\GraphQL\Mutations\CreateArticle::class,
                'updateArticle'=>\App\GraphQL\Mutations\UpdateArticle::class,
                'deleteArticle'=>\App\GraphQL\Mutations\DeleteArticle::class,
            ],
            'middleware'=>['auth:api']
        ]
    ],
